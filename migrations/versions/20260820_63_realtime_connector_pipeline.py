...
def upgrade() -> None:
    op.add_column("sync_cursors", sa.Column("status", sa.String(length=30), nullable=False, server_default="ready"))
    op.add_column("sync_cursors", sa.Column("full_sync_required", sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column("sync_cursors", sa.Column("last_notification_at", sa.DateTime(), nullable=True))
    op.add_column("sync_cursors", sa.Column("last_reconcile_at", sa.DateTime(), nullable=True))
    op.add_column("sync_cursors", sa.Column("last_error", sa.Text(), nullable=True))
    op.alter_column("sync_cursors", "status", server_default=None)
    op.alter_column("sync_cursors", "full_sync_required", server_default=None)

    op.add_column("webhook_subscriptions", sa.Column("resource", sa.String(length=1024), nullable=True))
    op.add_column("webhook_subscriptions", sa.Column("lifecycle_notification_url", sa.String(length=2048), nullable=True))
    op.add_column("webhook_subscriptions", sa.Column("reauthorization_required", sa.Boolean(), nullable=False, server_default=sa.false()))
    op.add_column("webhook_subscriptions", sa.Column("last_notification_at", sa.DateTime(), nullable=True))
    op.add_column("webhook_subscriptions", sa.Column("last_lifecycle_at", sa.DateTime(), nullable=True))
    op.add_column("webhook_subscriptions", sa.Column("renewal_attempts", sa.Integer(), nullable=False, server_default="0"))
    op.add_column("webhook_subscriptions", sa.Column("last_error", sa.Text(), nullable=True))
    op.alter_column("webhook_subscriptions", "reauthorization_required", server_default=None)
    op.alter_column("webhook_subscriptions", "renewal_attempts", server_default=None)
    ...
    op.create_index("ix_connector_notifications_status_received", "connector_notifications", ["status", "received_at"])
    ...
    op.create_index("ix_sync_requests_dispatch", "sync_requests", ["status", "available_at"])
    op.create_index("ix_sync_requests_connector_status", "sync_requests", ["connector_id", "status"])
