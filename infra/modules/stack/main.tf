...
module "secrets" {
  ...
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/secrets?ref=secrets-v2.1.1"
...
module "rds" {
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/rds?ref=rds-v2.1.2"
...
module "cache" {
  ...
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/cache?ref=cache-v1.0.0"
...
// ── ECS cluster ───────────────────────────────────────────────────────────────
module "ecs_cluster" {
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/ecs-cluster?ref=ecs-cluster-v2.0.0"
...
module "tunnel" {
  ...
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/cf-tunnel?ref=cf-tunnel-v0.1.1"
...
module "tunnel_api" {
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/tunnel-agent?ref=tunnel-agent-v1.0.0"
...
// ── API service ───────────────────────────────────────────────────────────────
module "api" {
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/ecs-service?ref=ecs-service-v2.1.1"
...
module "migrator" {
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/oneshot-task?ref=oneshot-task-v2.0.0"
...
module "web" {
  ...
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/pages-web?ref=pages-web-v1.0.1"
...
module "dns_api" {
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/dns-record?ref=dns-record-v1.1.0"
...
module "observability" {
  source = "git::https://github.com/BKL-HCM/qnsc-tf-modules.git//modules/observability?ref=observability-v4.1.0"
