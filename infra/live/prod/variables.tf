...
variable "alarm_emails" {
  ...
  #
  # ARMED 2026-09-12, ahead of this environment's first apply, so it is never live without
  # a notification path — the failure mode found across every other stack on that date.
